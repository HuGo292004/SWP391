  ...
  const navItems = [
    {
      ...
      label: (
        <>
          <HomeOutlined
            style={{ fontSize: 15, marginRight: 6, color: "#ffffff" }}
          />
          TRANG CHỦ
        </>
      ),
      ...
      >
        {isAuthenticated ? (
          <>
            <div
              style={{
                backgroundColor: healthThemeColors.light,
                padding: "16px",
              }}
            >
              <div
              ...
              >
                <Avatar
                  size={50}
                  icon={<UserOutlined />}
                  style={{ backgroundColor: healthThemeColors.primary }}
                />
                <div>
                  ...
                  ? [
                      {
                        ...
                        label: (
                          <Link to="/member/blood-donation-profile">
                            Hồ sơ hiến máu
                          </Link>
                        ),
                      },
