...
/**
 * Component Benefits Slider
 * Hiển thị các quyền lợi của người hiến máu dưới dạng carousel
 */
const BenefitsSlider = () => {
  // State quản lý slide hiện tại
  const [index, setIndex] = useState(0);

  // State quản lý trạng thái hover để tạm dừng auto-scroll
  const [isHovered, setIsHovered] = useState(false);

  /**
   * Xử lý khi chọn slide
   * @param {number} selectedIndex - Index của slide được chọn
   */
  const handleSelect = (selectedIndex) => {
    setIndex(selectedIndex);
  };

  // Auto-advance với tính năng tạm dừng khi hover
  useEffect(() => {
    if (!isHovered) {
  ...
  // Dữ liệu các quyền lợi hiến máu
  const benefits = [
    {
      id: 1,
      ...
      backgroundImage:
        "https://images.unsplash.com/photo-1615461066841-6116e61058f4?q=80&w=1920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      textColor: "#ffffff",
      type: "intro",
    ...
    },
    {
      ...
      backgroundImage:
        "https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=1920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      textColor: "#ffffff",
      type: "content",
    ...
    },
    {
      ...
      backgroundImage:
        "https://images.unsplash.com/photo-1551190822-a9333d879b1f?q=80&w=1920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      textColor: "#ffffff",
      type: "content",
      icon: (
        <MedicineBoxOutlined style={{ fontSize: "3rem", color: "#ffffff" }} />
      ),
      content: [
        {
    ...
    },
    {
      ...
      backgroundImage:
        "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?q=80&w=1920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      textColor: "#ffffff",
      type: "content",
      ...
      >
        <Row className="justify-content-center align-items-center h-100">
          <Col lg={6} xl={5} className="text-center">
            ...
            <p className="lead fs-4 mb-4 text-shadow">{benefit.subtitle}</p>
          </Col>
        </Row>
      </Container>
    </div>
        ...
        <Row className="justify-content-center align-items-center h-100">
          <Col lg={11} xl={10}>
            <div className="text-center mb-5">
              <div className="mb-4">{benefit.icon}</div>
              <h2 className="display-5 fw-bold text-white mb-0 text-shadow-light">
                {benefit.title}
              </h2>
            </div>
